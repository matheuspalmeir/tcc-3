...
file = 'C:/Users/gtvol/Downloads/campo/Dataset/Sentinel-1 (zip)/images/04Dec_2015_VH.tif'
...
feature_map = campo.haralick_features(raster, win, d, theta, levels, props,file,df, month[0],class_dict)
