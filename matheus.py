...
name_save = '21Mar_2016_VVteste'
file = 'C:/Users/mathe/Documents/TCC/Dataset/Sentinel-1/Sentinel-1/9_March_2/21Mar_2016_VV.tif'
#Leitura da imagem 
...
df = gpd.read_file('./Reference/CampoVerde_Oct2015_Jul2016.shp')
...
Xs,ys = campo.haralick_features(raster, win, d, theta, levels, props,file,df, month[5],class_dict,name_save)
